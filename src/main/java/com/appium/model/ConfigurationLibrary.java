...
public class ConfigurationLibrary {
	...
	public static final String projectName = "Redbox Automation ";
	public static final String deviceName = "iPhone 6s"; //03c8c6372518f466
	public static final String apiLevel = "5.0"; //5.0
	public static final String fileName = "birdzi.apk";	
	public static final String packageName = "com.birdzi.countymarket"; //com.dfc.uatmoneymartca
	public static final String activityName = "md5d556e451cf0e46d30b1c8d323181862a.SplashActivity"; //com.dfc.moneymartca.view.activity.SplashActivity

	public static final String UD_ID="e5134d4d9ea3aa1a06c0032d8810d4fbdb8eff8c";
	public static final String Bundle_Id="com.redbox.Redbox";
	public static final String platform_version="11.1";
